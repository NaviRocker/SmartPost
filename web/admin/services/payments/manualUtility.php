<?php
    ...
    if(mysqli_connect($host,$Hname,$Hpwd,$dbname)){
        ...
        if(!empty($_POST['name']) && !empty($_POST['accNo']) && !empty($_POST['amount']) && !empty($_POST['method'])) {
        //if(!empty($_POST['accNo']) && !empty($_POST['amount']) && !empty($_POST['method'])) {
            ...
            $query = "INSERT INTO manual_utilitybill (name, accNo, amount, method, refNo, cashCollected) VALUES ('$name', '$accNo', '$amount', '$method', '$refNo', '$cashCollected')";
            //$query = "INSERT INTO manual_utilitybill (accNo, amount, method, refNo, cashCollected) VALUES ('$accNo', '$amount', '$method', '$refNo', '$cashCollected')";
